...
ARG USER_NAME="gitsrealpe"
ARG USER_EMAIL="gitsrealpe@todo.com"
...
RUN apt-get install -y \
  ...
  texinfo unzip wget xz-utils zstd lz4 libgtk-3-dev
...
# add sudo command for flutter_workspace.py workspace generation
...
# WORKDIR /home/dev/
# RUN git clone https://github.com/meta-flutter/workspace-automation
# WORKDIR /home/dev/workspace-automation
# RUN python3 flutter_workspace.py

RUN echo "PS1='\[\033[01;32m\]\u\[\033[00m\]@\[\033[01;31m\]\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '" >> /home/dev/.bashrc
